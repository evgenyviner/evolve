...
<ul class="sc_menu">
	...
	if ( ! empty( $evolve_rss_feed ) ) { ?>
        <li><a target="_blank" href="<?php echo $evolve_rss_feed; ?>" class="tipsytext" id="rss"
	...
	if ( ! empty( $evolve_newsletter ) ) {
        ...
        <li><a target="_blank" href="<?php if ( $evolve_newsletter != "" ) {
			...
			} ?>" class="tipsytext" id="email-newsletter" title="<?php _e( 'Newsletter', 'evolve' ); ?>"><i
