	...
	?>">
        ...
        <div class="header-border-sticky">
            ...
            <div class="header">
                ...
                </div><!-- .container .container-header .header_v0 -->

            </div><!-- .header -->
        </div><!-- .header-border-sticky -->
    </div><!-- .header-border -->
</div><!-- .header-pattern -->
</div>
                            ...
                            <form action="<?php echo home_url(); ?>" method="get" class="searchform col-md-1 col-sm-1">
                                <div id="search-text-box">
                                    <label class="searchfield col-md-1 col-sm-1" id="search_label_top"
                                           for="search-text-top"><input id="search-text-top" type="text" tabindex="1"
                                                                        name="s" class="search"
