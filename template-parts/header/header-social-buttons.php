...
<ul class="sc_menu">
	...
	if ( ! empty( $evolve_newsletter ) ) {
        ...
        <li><a target="_blank" href="<?php if ( $evolve_newsletter != "" ) {
			...
			} ?>" data-toggle="tooltip" data-placement="bottom" id="email-newsletter" title="<?php esc_html_e( 'Newsletter', 'evolve' ); ?>"><i
	...
	if ( ! empty( $evolve_googleplus ) ) {
        ...
        <li><a target="_blank" href="<?php echo $evolve_googleplus; ?>" data-toggle="tooltip" data-placement="bottom" id="plus"
               title="<?php esc_html_e( 'Google Plus', 'evolve' ); ?>"><i class="t4p-icon-social-google-plus"></i></a></li>
		<?php
	}
