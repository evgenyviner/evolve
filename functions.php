...
function evolve_footer_hooks() {
	...
	<?php global $evolve_options, $evolve_front_elements_header_area, $evolve_sticky_header, $evolve_page_ID;
	$evolve_header_pos = '';
...
function evolve_script() {
	...
	wp_enqueue_script( 'supersubs', EVOLVE_JS . '/supersubs.min.js', array( 'jquery' ), '', true );
	...
	wp_add_inline_style( 'evolve-bootstrap', $evolve_css_data );
