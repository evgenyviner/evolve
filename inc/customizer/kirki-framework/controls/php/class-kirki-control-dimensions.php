...
class Kirki_Control_Dimensions extends Kirki_Control_Base {
	...
	protected function l10n() {
		return array(
			...
			'font-size'      => esc_attr__( 'Font Size', 'evolve' ),
			'font-weight'    => esc_attr__( 'Font Weight', 'evolve' ),
			'line-height'    => esc_attr__( 'Line Height', 'evolve' ),
			'font-style'     => esc_attr__( 'Font Style', 'evolve' ),
			'letter-spacing' => esc_attr__( 'Letter Spacing', 'evolve' ),
			'word-spacing'   => esc_attr__( 'Word Spacing', 'evolve' ),
			'top'            => esc_attr__( 'Top', 'evolve' ),
			'bottom'         => esc_attr__( 'Bottom', 'evolve' ),
			'left'           => esc_attr__( 'Left', 'evolve' ),
			'right'          => esc_attr__( 'Right', 'evolve' ),
			'center'         => esc_attr__( 'Center', 'evolve' ),
			'size'           => esc_attr__( 'Size', 'evolve' ),
			'height'         => esc_attr__( 'Height', 'evolve' ),
			'spacing'        => esc_attr__( 'Spacing', 'evolve' ),
			'width'          => esc_attr__( 'Width', 'evolve' ),
			'height'         => esc_attr__( 'Height', 'evolve' ),
			'invalid-value'  => esc_attr__( 'Invalid Value', 'evolve' ),
		);
	}
}
