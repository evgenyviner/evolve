...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'evolve' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'evolve' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'evolve' ),
			'200'       => esc_attr__( 'Light 200', 'evolve' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'evolve' ),
			'300'       => esc_attr__( 'Book 300', 'evolve' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'evolve' ),
			'400'       => esc_attr__( 'Normal 400', 'evolve' ),
			'regular'   => esc_attr__( 'Normal 400', 'evolve' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'evolve' ),
			'500'       => esc_attr__( 'Medium 500', 'evolve' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'evolve' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'evolve' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'evolve' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'evolve' ),
			'700'       => esc_attr__( 'Bold 700', 'evolve' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'evolve' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'evolve' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'evolve' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'evolve' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'evolve' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'evolve' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'evolve' ),
		);
	}
