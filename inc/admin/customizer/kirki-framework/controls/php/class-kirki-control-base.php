	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_attr__( 'No File Selected', 'evolve' ),
				'remove'               => esc_attr__( 'Remove', 'evolve' ),
				'default'              => esc_attr__( 'Default', 'evolve' ),
				'selectFile'           => esc_attr__( 'Select File', 'evolve' ),
				'standardFonts'        => esc_attr__( 'Standard Fonts', 'evolve' ),
				'googleFonts'          => esc_attr__( 'Google Fonts', 'evolve' ),
				'defaultCSSValues'     => esc_attr__( 'CSS Defaults', 'evolve' ),
				'defaultBrowserFamily' => esc_attr__( 'Default Browser Font-Family', 'evolve' ),
			)
		);
