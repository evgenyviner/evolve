...
if ( $evolve_menu_background == "1" ) {
	$evolve_css_data .= '.menu-header, .sticky-header { text-shadow: none; } .menu-header, .new_menu_class, form.top-searchform, .p-menu-stick.stuckMenu.isStuck, .sticky-header { filter: none; background: #' . $evolve_menu_back_color . '; border: none; -webkit-box-shadow: none; -moz-box-shadow: none; -box-shadow: none; box-shadow: none; }';
	$evolve_css_data .= '.sticky-header { background: #' . $evolve_menu_back_color . '; border: 0; }';
}
...
if ( $evolve_post_layout == "two" ) {
	...
	$evolve_css_data .= '.home .type-post .entry-content, .archive .type-post .entry-content, .search .type-post .entry-content, .page-template-blog-page-php .type-post .entry-content { font-size: 13px; } .entry-content { margin-top: 25px; } .home .entry-title, .entry-title a, .archive .entry-title, .search .entry-title, .page-template-blog-page-php .entry-title { font-size: 120%; line-height: 120%; margin-bottom: 0; } .home .entry-header, .archive .entry-header, .search .entry-header, .page-template-blog-page-php .entry-header { font-size: 12px; padding: 0; } .home .published strong, .archive .published strong, .search .published strong, .page-template-blog-page-php .published strong { font-size: 15px; line-height: 15px; } .home .hfeed, .archive .hfeed, .single .hfeed, .page .hfeed, .page-template-blog-page-php .hfeed { margin-right: 0; } .home .type-post .entry-footer, .archive .type-post .entry-footer, .search .type-post .entry-footer, .page-template-blog-page-php .type-post .entry-footer { float: left; width: 100% } .home .type-post .comment-count, .archive .type-post .comment-count, .search .type-post .comment-count, .page-template-blog-page-php .type-post .comment-count { background: none; padding-right: 0; }';
}
...
if ( ( $evolve_tagline_pos !== "disable" ) && ( $evolve_tagline_pos == "next" ) ) {
	$evolve_css_data .= '.title-container #logo { float: left; padding-right: 10px; } .title-container #tagline { padding-top: 20px; } .title-container #logo a { padding: 0 20px 0 0; }';
}

if ( $evolve_pos_logo == "right" || $evolve_pos_logo == "left" || $evolve_pos_logo == "disable" ) {
	$evolve_css_data .= '.title-container #logo a { padding: 0 20px 0 3px; }';
}

if ( $evolve_header_logo != "" && $evolve_pos_logo == "left" && $evolve_tagline_pos == "above" && $evolve_pos_logo !== 'disable' ) {
	$evolve_css_data .= '.title-container #logo a { margin-left: 0; }';
}
...
if ( $evolve_pos_logo == "right" ) {
	$evolve_css_data .= '.header-logo-container { clear: right; }';
}

if ( $evolve_pos_logo == "left" || $evolve_pos_logo == "center" || $evolve_pos_logo == "right" ) {
	$evolve_css_data .= '.sticky-header #logo { float: left; padding: 6px 6px 6px 3px; } .sticky-header #sticky-logo { float: left; padding: 0 6px 0 3px; } body .sticky-headerimg#logo-image { margin-left: 10px; }';
}

if ( $evolve_pos_logo == "disable" ) {
	$evolve_css_data .= '.sticky-header #logo { float: left; padding: 6px 6px 6px 3px; } .sticky-header #sticky-logo { float: left; padding: 0 6px 0 3px; }';
}
...
if ( $evolve_widget_background == "1" ) {
	if ( $evolve_widget_bgcolor != "" ) {
		...
		$evolve_css_data           .= '#content h3.widget-title, h3.widget-title { color: #fff; text-shadow: 1px 1px 0 #000; } .widget-title-background { position: absolute; top: -1px; bottom: 0; left: -16px; right: -16px; -webkit-border-radius: 3px 3px 0 0; -moz-border-radius: 3px 3px 0 0; border-radius: 3px 3px 0 0; border: 1px solid; border-color: ' . $evolve_widget_bgcolor . '; background: ' . $evolve_widget_bgcolor . '; -webkit-box-shadow: 0 1px 0 rgba(255, 255, 255, 0.3) inset, 0 0 5px rgba(0, 0, 0, 0.3) inset, 0 1px 2px rgba(0, 0, 0, 0.29); -moz-box-shadow: 0 1px 0 rgba(255, 255, 255, 0.3) inset, 0 0 5px rgba(0, 0, 0, 0.3) inset, 0 1px 2px rgba(0, 0, 0, 0.29); -box-shadow: 0 1px 0 rgba(255, 255, 255, 0.3) inset, 0 0 5px rgba(0, 0, 0, 0.3) inset, 0 1px 2px rgba(0, 0, 0, 0.29); box-shadow: 0 1px 0 rgba(255, 255, 255, 0.3) inset, 0 0 5px rgba(0, 0, 0, 0.3) inset, 0 1px 2px rgba(0, 0, 0, 0.29); color: #fff; }';
	}
}
...
if ( ( $evolve_tagline_pos !== "disable" ) && ( $evolve_tagline_pos == "next" ) ) {
	$evolve_css_data .= '.title-container #tagline { padding-top: 10px; }';
}
