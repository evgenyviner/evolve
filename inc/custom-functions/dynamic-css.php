...
$evolve_header_padding         = evolve_theme_mod( 'evl_content_top_bottom_padding' );
$evolve_content_top_padding    = $evolve_header_padding['padding-top'];
$evolve_content_bottom_padding = $evolve_header_padding['padding-bottom'];
...
$evolve_content_boxes_section_padding_top         = $evolve_content_boxes_section_padding['padding-top'];
$evolve_content_boxes_section_padding_bottom      = $evolve_content_boxes_section_padding['padding-bottom'];
$evolve_content_boxes_section_padding_left        = $evolve_content_boxes_section_padding['padding-left'];
$evolve_content_boxes_section_padding_right       = $evolve_content_boxes_section_padding['padding-right'];
...
if ( is_home() || is_front_page() ) {
	if ( $evolve_width_px && ( $evolve_frontpage_width_layout == "fixed" ) ) {
		$evolve_css_data .= '@media (min-width: ' . $evolve_min_width_px . 'px) { .container, #wrapper { width: 100%; max-width: ' . $evolve_width_px . 'px; } }';
	} else {
...
if ( $evolve_post_layout == "three" ) {
	...
	$evolve_css_data .= '@media (min-width: 768px) { .home .card-columns, .blog .card-columns { -webkit-column-count: 3; -moz-column-count: 3; column-count: 3; } } @media (min-width: 577px) and (max-width: 767px) { .home .card-columns, .blog .card-columns { -webkit-column-count: 2; -moz-column-count: 2; column-count: 2; } } @media (max-width: 576px) { .home .card-columns, .blog .card-columns { -webkit-column-count: 1; -moz-column-count: 1; column-count: 1; } }.home .type-post .entry-content, .archive .type-post .entry-content, .search .type-post .entry-content, .page-template-blog-page-php .type-post .entry-content { font-size: 13px; } .entry-content { margin-top: 25px; } .home .entry-title, .entry-title a, .archive .entry-title, .search .entry-title, .page-template-blog-page-php .entry-title { font-size: 120%; line-height: 120%; margin-bottom: 0; } .home .entry-header, .archive .entry-header, .search .entry-header, .page-template-blog-page-php .entry-header { font-size: 12px; padding: 0; } .home .published strong, .archive .published strong, .search .published strong, .page-template-blog-page-php .published strong { font-size: 15px; line-height: 15px; } .home .type-post .comment-count, .archive .type-post .comment-count, .search .type-post .comment-count, .page-template-blog-page-php .type-post .comment-count { background: none; padding-right: 0; }';
}
...
$evolve_css_data .= evolve_print_fonts( 'evl_content_boxes_title_alignment', 'h4.content_box_section_title', $additional_css = '' );

//Testimonials Title Section
$evolve_css_data .= evolve_print_fonts( 'evl_testimonials_title_alignment', 'h4.testimonials_section_title', $additional_css = '' );

//Counter Circle Title Section
$evolve_css_data .= evolve_print_fonts( 'evl_counter_circle_title_alignment', 'h4.counter_circle_section_title', $additional_css = '' );

//Google Map Title Section
$evolve_css_data .= evolve_print_fonts( 'evl_googlemap_title_alignment', 'h4.googlemap_section_title', $additional_css = '' );

// Woocommerce Product Title Section
if ( class_exists( 'Woocommerce' ) ) :
	$evolve_css_data .= evolve_print_fonts( 'evl_woo_product_title_alignment', 'h4.woo_product_section_title', $additional_css = '' );
endif;

//Custom Content Title Section
$evolve_css_data .= evolve_print_fonts( 'evl_custom_content_title_alignment', 'h4.custom_content_section_title', $additional_css = '' );

//Blog Title Section
$evolve_css_data .= evolve_print_fonts( 'evl_blog_section_title_alignment', 'h4.fp_blog_section_title', $additional_css = '' );
...
if ( $evolve_shortcode_button_type == '3d' && $evolve_shortcode_button_bevel_color ) {
	$evolve_css_data .= '.btn, #reviews input#submit, .wpcf7-form input[type="submit"], .wpcf7-submit, .product-buttons .add_to_cart_button, .product-buttons .button.product_type_grouped, .product-buttons .button.product_type_simple, .product-buttons .button.product_type_external { -webkit-box-shadow: 0px 2px 0px ' . $evolve_shortcode_button_bevel_color . '; -moz-box-shadow: 0px 2px 0px ' . $evolve_shortcode_button_bevel_color . '; box-shadow: 0px 2px 0px ' . $evolve_shortcode_button_bevel_color . '; } .btn:active, #reviews input#submit:active, .bbp-submit-wrapper button:active, .wpcf7-form input[type="submit"]:active, .wpcf7-submit:active, .product-buttons .add_to_cart_button:active, .product-buttons .button.product_type_grouped:active, .product-buttons .button.product_type_simple:active, .product-buttons .button.product_type_external:active { -webkit-box-shadow: 0px 1px 0px ' . $evolve_shortcode_button_bevel_color . '; -moz-box-shadow: 0px 1px 0px ' . $evolve_shortcode_button_bevel_color . '; box-shadow: 0px 1px 0px ' . $evolve_shortcode_button_bevel_color . '; } .btn:hover, #reviews input#submit:hover, .bbp-submit-wrapper button:hover, .wpcf7-form input[type="submit"]:hover, .wpcf7-submit:hover, .price_slider_amount button:hover, .product-buttons .add_to_cart_button:hover, .product-buttons .button.product_type_grouped:hover, .product-buttons .button.product_type_simple:hover, .product-buttons .button.product_type_external:hover { -webkit-box-shadow: 0px 2px 0px ' . $evolve_shortcode_button_border_hover_color . '; -moz-box-shadow: 0px 2px 0px ' . $evolve_shortcode_button_border_hover_color . '; box-shadow: 0px 2px 0px ' . $evolve_shortcode_button_border_hover_color . '; } .woocommerce form.checkout #place_order, .bbp-submit-wrapper button.button-medium, .wpcf7-form input[type="submit"].button-medium, .wpcf7-submit.button-medium { -webkit-box-shadow: 0px 3px 0px ' . $evolve_shortcode_button_bevel_color . '; -moz-box-shadow: 0px 3px 0px ' . $evolve_shortcode_button_bevel_color . '; box-shadow: 0px 3px 0px ' . $evolve_shortcode_button_bevel_color . '; } .woocommerce form.checkout #place_order:active, .bbp-submit-wrapper button.button-medium:active, .wpcf7-form input[type="submit"].button-medium:active, .wpcf7-submit.button-medium:active { -webkit-box-shadow: 0px 1px 0px ' . $evolve_shortcode_button_bevel_color . '; -moz-box-shadow: 0px 1px 0px ' . $evolve_shortcode_button_bevel_color . '; box-shadow: 0px 1px 0px ' . $evolve_shortcode_button_bevel_color . '; } .woocommerce form.checkout #place_order:hover, .bbp-submit-wrapper button.button-medium:hover, .wpcf7-form input[type="submit"].button-medium:hover, .wpcf7-submit.button-medium:hover { -webkit-box-shadow: 0px 3px 0px ' . $evolve_shortcode_button_border_hover_color . '; -moz-box-shadow: 0px 3px 0px ' . $evolve_shortcode_button_border_hover_color . '; box-shadow: 0px 3px 0px ' . $evolve_shortcode_button_border_hover_color . '; } .bbp-submit-wrapper button.button-large, .wpcf7-form input[type="submit"].button-large, .wpcf7-submit.button-large { -webkit-box-shadow: 0px 4px 0px ' . $evolve_shortcode_button_bevel_color . '; -moz-box-shadow: 0px 4px 0px ' . $evolve_shortcode_button_bevel_color . '; box-shadow: 0px 4px 0px ' . $evolve_shortcode_button_bevel_color . '; } .bbp-submit-wrapper button.button-large:active, .wpcf7-form input[type="submit"].button-large:active, .wpcf7-submit.button-large:active { -webkit-box-shadow: 0px 1px 0px ' . $evolve_shortcode_button_bevel_color . '; -moz-box-shadow: 0px 1px 0px ' . $evolve_shortcode_button_bevel_color . '; box-shadow: 0px 1px 0px ' . $evolve_shortcode_button_bevel_color . '; } .bbp-submit-wrapper button.button-large:hover, .wpcf7-form input[type="submit"].button-large:hover, .wpcf7-submit.button-large:hover { -webkit-box-shadow: 0px 4px 0px ' . $evolve_shortcode_button_border_hover_color . '; -moz-box-shadow: 0px 4px 0px ' . $evolve_shortcode_button_border_hover_color . '; box-shadow: 0px 4px 0px ' . $evolve_shortcode_button_border_hover_color . '; } .button.button-3d.button-xlarge, .button.default.button-3d.button-xlarge, .button.default.xlarge, .bbp-submit-wrapper button.button-xlarge, .wpcf7-form input[type="submit"].button-xlarge, .wpcf7-submit.button-xlarge { -webkit-box-shadow: 0px 5px 0px ' . $evolve_shortcode_button_bevel_color . ', 1px 7px 7px 3px rgba(0,0,0,0.3); -moz-box-shadow: 0px 5px 0px ' . $evolve_shortcode_button_bevel_color . ', 1px 7px 7px 3px rgba(0,0,0,0.3); box-shadow: 0px 5px 0px ' . $evolve_shortcode_button_bevel_color . ', 1px 7px 7px 3px rgba(0,0,0,0.3); } .bbp-submit-wrapper button.button-xlarge:active, .wpcf7-form input[type="submit"].button-xlarge:active, .wpcf7-submit.button-xlarge:active { -webkit-box-shadow: 0px 2px 0px ' . $evolve_shortcode_button_bevel_color . ', 1px 7px 7px 3px rgba(0,0,0,0.3); -moz-box-shadow: 0px 2px 0px ' . $evolve_shortcode_button_bevel_color . ', 1px 7px 7px 3px rgba(0,0,0,0.3); box-shadow: 0px 2px 0px ' . $evolve_shortcode_button_bevel_color . ', 1px 7px 7px 3px rgba(0,0,0,0.3); } .bbp-submit-wrapper button.button-xlarge:hover, .wpcf7-form input[type="submit"].button-xlarge:hover, .wpcf7-submit.button-xlarge:hover { -webkit-box-shadow: 0px 5px 0px ' . $evolve_shortcode_button_border_hover_color . ', 1px 7px 7px 3px rgba(0,0,0,0.3); -moz-box-shadow: 0px 5px 0px ' . $evolve_shortcode_button_border_hover_color . ', 1px 7px 7px 3px rgba(0,0,0,0.3); box-shadow: 0px 5px 0px ' . $evolve_shortcode_button_border_hover_color . ', 1px 7px 7px 3px rgba(0,0,0,0.3); }';
}

if ( $evolve_shortcode_button_accent_color ) {
	$evolve_css_data .= '.btn, .gform_wrapper .gform_button, .woocommerce form.checkout #place_order, #reviews input#submit, .woocommerce .button.view, .woocommerce .wc-backward, .wpcf7-form input[type="submit"], .wpcf7-submit, .product-buttons .add_to_cart_button, .product-buttons .button.product_type_grouped, .product-buttons .button.product_type_simple, .product-buttons .button.product_type_external, #content .entry-content .product-buttons a:link { color: ' . $evolve_shortcode_button_accent_color . '; }';
}

if ( $evolve_shortcode_button_accent_hover_color ) {
	$evolve_css_data .= '.btn:hover, .gform_wrapper .gform_button:hover, .woocommerce form.checkout #place_order:hover, #reviews input#submit:hover, .woocommerce .login .button:hover, .woocommerce .register .button:hover, .woocommerce .wc-backward, .woocommerce .button.view:hover, .bbp-submit-wrapper button:hover, .wpcf7-form input[type="submit"]:hover, .wpcf7-submit:hover, .product-buttons .add_to_cart_button:hover, .product-buttons .button.product_type_grouped:hover, .product-buttons .button.product_type_simple:hover, .product-buttons .button.product_type_external:hover, #content .entry-content .product-buttons a:hover { color: ' . $evolve_shortcode_button_accent_hover_color . '; } .tagcloud a:hover { color: ' . $evolve_shortcode_button_accent_hover_color . ' !important; }';
}

if ( $evolve_shortcode_button_shadow == '1' && $evolve_shortcode_button_type == 'Flat' ) {
	$evolve_css_data .= '.btn { text-shadow: none; box-shadow: none; }';
}

if ( $evolve_shortcode_button_shadow == '1' && $evolve_shortcode_button_type == '3d' ) {
	$evolve_css_data .= '.btn { text-shadow: none; }';
}

if ( $evolve_shortcode_button_border_width ) {
	$evolve_css_data .= '.btn, .gform_wrapper .gform_button, .woocommerce form.checkout #place_order, #reviews input#submit, .woocommerce-message .wc-forward, .woocommerce .wc-backward, .woocommerce .button.view, .wpcf7-form input[type="submit"], .wpcf7-submit, .product-buttons .add_to_cart_button, .product-buttons .button.product_type_grouped, .product-buttons .button.product_type_simple, .product-buttons .button.product_type_external { border-width: ' . $evolve_shortcode_button_border_width . '; border-style: solid; } .btn:hover, .t4p-accordian .panel-title a.active, .price_slider_amount button:hover { border-width: ' . $evolve_shortcode_button_border_width . '; border-style: solid; }';
}

if ( $evolve_shortcode_button_border_width && $evolve_shortcode_button_border_color ) {
	$evolve_css_data .= '.btn, .gform_wrapper .gform_button, .woocommerce form.checkout #place_order, #reviews input#submit, .woocommerce-message .wc-forward, .woocommerce .wc-backward, .woocommerce .button.view, .wpcf7-form input[type="submit"], .wpcf7-submit, .woocommerce-pagination .current, .t4p-accordian .panel-title a.active, .product-buttons .add_to_cart_button, .product-buttons .button.product_type_grouped, .product-buttons .button.product_type_simple, .product-buttons .button.product_type_external { border-color: ' . $evolve_shortcode_button_border_color . '; }';
}

if ( $evolve_shortcode_button_border_width && $evolve_shortcode_button_border_hover_color ) {
	$evolve_css_data .= '
.btn:hover, .gform_wrapper .gform_button:hover, .woocommerce form.checkout #place_order:hover, .woocommerce-message .wc-forward:hover, .woocommerce .wc-backward:hover, .woocommerce .button.view:hover, #reviews input#submit:hover, .woocommerce .login .button:hover, .woocommerce .register .button:hover, .bbp-submit-wrapper button:hover, .wpcf7-form input[type="submit"]:hover, .wpcf7-submit:hover, .woocommerce-pagination .current:hover, .price_slider_amount button:hover, .product-buttons .add_to_cart_button:hover, .product-buttons .button.product_type_grouped:hover, .product-buttons .button.product_type_simple:hover, .product-buttons .button.product_type_external:hover { border-color: ' . $evolve_shortcode_button_border_hover_color . ' !important; }';
}

if ( $evolve_shortcode_button_shape == 'Pill' ) {
	$evolve_css_data .= '.btn, .woocommerce form.checkout #place_order, #reviews input#submit, .woocommerce-message .wc-forward, .woocommerce .wc-backward, .woocommerce .button.view, .wpcf7-form input[type="submit"], .wpcf7-submit, .product-buttons .add_to_cart_button, .product-buttons .button.product_type_grouped, .product-buttons .button.product_type_simple, .product-buttons .button.product_type_external { border-radius: 25px; }';
}
...
if ( $evolve_shortcode_button_gradient_top_color ) {
	$evolve_css_data .= '.btn, #reviews input#submit, .tagcloud a:hover, h5.toggle.active a, h5.toggle.active a:hover, .gform_wrapper .gform_button, .woocommerce-pagination .current, .widget_shopping_cart_content .buttons a, .woocommerce-message .wc-forward, .woocommerce .wc-backward, .woocommerce .button.view, .product-buttons .add_to_cart_button, .product-buttons .button.product_type_grouped, .product-buttons .button.product_type_simple, .product-buttons .button.product_type_external, .wpcf7-form input[type="submit"], .wpcf7-submit, .woocommerce .button.view, .woocommerce form.checkout #place_order, .t4p-accordian .panel-title a.active { background: ' . $evolve_shortcode_button_gradient_top_color . '; ';
...
if ( $evolve_shortcode_button_gradient_top_hover_color && $evolve_shortcode_button_accent_hover_color ) {
	$evolve_css_data .= '.btn:hover, #reviews input#submit:hover, .wpcf7-form input[type="submit"]:hover, .wpcf7-submit:hover, .bbp-submit-wrapper button:hover, .button:hover, .button.default:hover, .price_slider_amount button:hover, .gform_wrapper .gform_button:hover, .woocommerce .shipping-calculator-form .button:hover, .woocommerce form.checkout #place_order:hover, .woocommerce .checkout_coupon .button:hover, .woocommerce .login .button:hover, .woocommerce .register .button:hover, .woocommerce .evolve-order-details .order-again .button:hover, .woocommerce .button.view:hover, .reading-box .button:hover, .woocommerce-pagination .page-numbers.current:hover, .product-buttons .add_to_cart_button:hover, .product-buttons .button.product_type_grouped:hover, .product-buttons .button.product_type_simple:hover, .product-buttons .button.product_type_external:hover { background: ' . $evolve_shortcode_button_gradient_top_hover_color . ';';
...
if ( $evolve_bootstrap_layout == "bootstrap_center" ) {
	...
	if ( isset( $evolve_bootstrap_slide_subtitle_font_rgba ) && $evolve_bootstrap_slide_subtitle_font_rgba ) {
		$evolve_bootstrap_slide_subtitle_font_rgba = $evolve_bootstrap_slide_subtitle_font_rgba;
	}
...
if ( isset( $evolve_bootstrap_slide_title_font_rgba ) && $evolve_bootstrap_slide_title_font_rgba ) {
	$evolve_bootstrap_slide_title_font_rgba = $evolve_bootstrap_slide_title_font_rgba;
}
