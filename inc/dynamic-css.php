...
if ( ! function_exists( 'evolve_dynamic_css' ) ) {
	function evolve_dynamic_css( $css_data ) {
		...
		$responsive_menu        = evolve_theme_mod( 'evl_responsive_menu', 'icon' );
		...
		$responsive_menu_layout = evolve_theme_mod( 'evl_responsive_menu_layout', 'basic' );
		...
		$top_menu_back_color                = evolve_theme_mod( 'evl_top_menu_back', '#273039' );
		...
		$main_pattern                       = evolve_theme_mod( 'evl_pattern', '' );
		...
		$scheme_background_repeat           = evolve_theme_mod( 'evl_scheme_background_repeat', 'repeat' );
		$primary_link                       = evolve_theme_mod( 'evl_general_link', '#0bb697' );
		...
		$content_box_background_color       = evolve_theme_mod( 'evl_content_box_background_color', '#efefef' );
		$form_bg_color                      = evolve_theme_mod( 'evl_form_bg_color', '#ffffff' );
		...
		$component_color                    = evolve_theme_mod( 'evl_form_item_color', '#0bb697' );
		...
		$button_shape                       = evolve_theme_mod( 'evl_shortcode_button_shape', 'Round' );
		$button_type                        = evolve_theme_mod( 'evl_shortcode_button_type', '3d' );
		$button_gradient_top_color          = evolve_theme_mod( 'evl_shortcode_button_gradient_top_color', '#0bb697' );
		$button_gradient_bottom_color       = evolve_theme_mod( 'evl_shortcode_button_gradient_bottom_color', '#0bb697' );
		...
		$button_border_color                = evolve_theme_mod( 'evl_shortcode_button_border_color', '#0bb697' );
		$button_border_hover_color          = evolve_theme_mod( 'evl_shortcode_button_border_hover_color', '#313a43' );
		$button_border_width                = evolve_theme_mod( 'evl_shortcode_button_border_width', '1' );
		...
		$testimonials_section_back_color          = evolve_theme_mod( 'evl_testimonials_section_back_color', '' );
		...
		if ( ! ( '' == evolve_theme_mod( 'evl_menu_back_color', '#273039' ) ) ) {
			...
			$css_data .= '} .header-search .form-control:focus { background: ' . evolve_hex_change( $menu_back_color ) . '; }';

			if ( class_exists( 'Woocommerce' ) ) {
				$css_data .= ' .header .woocommerce-menu .dropdown-divider { border-color: ' . evolve_hex_change( $menu_back_color ) . '; }';
			}
		}
		...
		if ( ! empty( $top_menu_back_color ) && $header_type == 'h1' ) {
			$css_data .= ' .new-top-menu, .new-top-menu ul.nav-menu li.nav-hover ul { background: ' . $top_menu_back_color . '; } .new-top-menu ul.nav-menu ul li:hover > a, .new-top-menu ul.nav-menu li.current-menu-item > a, .new-top-menu ul.nav-menu li.current-menu-ancestor > a { border-top-color: ' . $top_menu_back_color . '; } .new-top-menu ul.nav-menu li.current-menu-ancestor li.current-menu-item > a, .new-top-menu ul.nav-menu li.current-menu-ancestor li.current-menu-parent > a { border-top-color: ' . $top_menu_back_color . '; } .new-top-menu ul.nav-menu ul { border: 1px solid ' . evolve_hex_change( $top_menu_back_color ) . '; border-bottom: 0; } .new-top-menu ul.nav-menu li { border-left-color: ' . evolve_hex_change( $top_menu_back_color ) . '; border-right-color: ' . $top_menu_back_color . '; } .new-top-menu ul.nav-menu li.current-menu-item, .new-top-menu ul.nav-menu li.current-menu-ancestor, .new-top-menu ul.nav-menu li:hover { border-right-color: ' . $top_menu_back_color . '; } .new-top-menu ul.nav-menu ul, .new-top-menu ul.nav-menu li li, .new-top-menu ul.nav-menu li li li, .new-top-menu ul.nav-menu li li li li { border-color: ' . evolve_hex_change( $top_menu_back_color ) . '; }';
		}
		...
		$css_data .= evolve_print_fonts( 'evl_menu_font', ' .navbar-nav .nav-link, .navbar-nav .dropdown-item, .menu-header, .sticky-header, .navbar-toggler' );

		/*
			Top Menu Font
			--------------------------------------- */

		$css_data .= evolve_print_fonts( 'evl_top_menu_font', ' .new-top-menu ul.nav-menu a, .top-menu, .header .woocommerce-menu .dropdown-menu' );
		...
		if ( $widget_background_image == "1" ) {
			$css_data .= ' .widget::before, .widget::after { -webkit-box-shadow: none; box-shadow: none; }';
		}
		...
		if ( $scheme_widgets != "" || $scheme_background || $scheme_background_100 == '1' || $scheme_background_repeat ) {
			...
			$css_data .= ' } .da-dots span { background: ' . evolve_hex_change( $scheme_widgets ) . '; }';
		}
		...
		if ( $button_border_width || ( $button_type == '3d' && $button_bevel_color ) || $button_accent_color || $button_gradient_top_color || $button_gradient_bottom_color || ( $button_shadow == '1' && $button_type == 'Flat' ) || ( $button_shadow == '1' && $button_type == '3d' ) || ( $button_border_width && $button_border_color ) || $button_shape == 'Pill' || $button_shape == 'Round' || $button_shape == 'Square' ) {
			...
			$css_data .= ' }';
			if ( class_exists( 'Woocommerce' ) ) {
				$css_data .= ' .header .woocommerce-menu .btn { color: ' . $button_accent_color . '; }';
			}
		}
		...
		if ( $social_box_radius != 'disabled' ) {
			$css_data .= ' .social-media-links li:last-child a { margin-right: 0; }';
		} else {
			$css_data .= ' .social-media-links li:last-child a { padding-right: 0; }';
		}
		...
		if ( $responsive_menu == 'disable' ) {
			$css_data .= ' .top-menu .menu { display: block; } .top-menu-social-container { clear: both; }';
		}
		...
		if ( $responsive_menu_layout == 'dropdown' ) {
			$css_data .= ' .navbar .dropdown-menu { display: block; }';
		}
		if ( $post_layout == "three" ) {
			$css_data .= ' .posts.card-columns { -webkit-column-count: 1; column-count: 1; }';
		}
		if ( ! ( '' == evolve_theme_mod( 'evl_menu_back_color', '#273039' ) ) ) {
			$menu_back_color = evolve_theme_mod( 'evl_menu_back_color', '#273039' );
			$css_data        .= ' .menu-header .search-form .form-control { border-color: ' . evolve_hex_change( $menu_back_color ) . '; background: ' . evolve_hex_change( $menu_back_color, - 8 ) . '; }';
		}
		...
		if ( ( get_post_meta( $slider_page_id, 'evolve_slider_type', true ) == 'bootstrap' && evolve_theme_mod( 'evl_bootstrap_slider_support', '1' ) == '1' ) || ( evolve_theme_mod( 'evl_bootstrap_slider', '0' ) == '1' && evolve_theme_mod( 'evl_bootstrap_slider_support', '1' ) == '1' ) || ( evolve_theme_mod( 'evl_bootstrap_slider_support', '1' ) == "1" && is_front_page() && ( evolve_theme_mod( 'evl_front_elements_header_area', array( 'bootstrap_slider' ) ) ) ) || ( evolve_theme_mod( 'evl_bootstrap_slider_support', '1' ) == "1" && is_home() && ( evolve_theme_mod( 'evl_front_elements_header_area', array( 'bootstrap_slider' ) ) ) ) || ( get_post_meta( $slider_page_id, 'evolve_slider_type', true ) == 'posts' && evolve_theme_mod( 'evl_carousel_slider', '0' ) == '1' ) || ( evolve_theme_mod( 'evl_posts_slider', '0' ) == '1' && evolve_theme_mod( 'evl_carousel_slider', '0' ) == '1' ) || ( evolve_theme_mod( 'evl_carousel_slider', '0' ) == "1" && is_front_page() && ( evolve_theme_mod( 'evl_front_elements_header_area', array( 'posts_slider' ) ) ) ) || ( evolve_theme_mod( 'evl_carousel_slider', '1' ) == "1" && is_home() && ( evolve_theme_mod( 'evl_front_elements_header_area', array( 'posts_slider' ) ) ) ) || ( get_post_meta( $slider_page_id, 'evolve_slider_type', true ) == 'parallax' && evolve_theme_mod( 'evl_parallax_slider_support', '0' ) == '1' ) || ( evolve_theme_mod( 'evl_parallax_slider', '0' ) == '1' && evolve_theme_mod( 'evl_parallax_slider_support', '0' ) == '1' ) || ( evolve_theme_mod( 'evl_parallax_slider_support', '0' ) == "1" && is_front_page() && ( evolve_theme_mod( 'evl_front_elements_header_area', array( 'parallax_slider' ) ) ) ) || ( evolve_theme_mod( 'evl_parallax_slider_support', '1' ) == "1" && is_home() && ( evolve_theme_mod( 'evl_front_elements_header_area', array( 'parallax_slider' ) ) ) ) ) {
			$css_data .= ' #bootstrap-slider .carousel-caption h5, #parallax-slider .carousel-caption h5, #posts-slider .carousel-caption h5 { font-size: 1.5rem; margin: 0; }';
		}
