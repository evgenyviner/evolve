...
// Parallax Slider
    ...
    if ( (get_post_meta($evolve_slider_page_id, 'evolve_slider_type', true) == 'parallax' && $evolve_parallax_on == "1") || ($evolve_bootstrap == "1" && $evolve_parallax_on == "1") ):
...
// Posts Slider
    ...
    if ( (get_post_meta($evolve_slider_page_id, 'evolve_slider_type', true) == 'posts' && $evolve_post_on == "1") || ($evolve_bootstrap == "1" && $evolve_post_on == "1") ):
