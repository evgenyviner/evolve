...
.navbar-nav li.menu-item.current-menu-item > span.um-anchoremulator,
.navbar-nav li.menu-item.current-menu-parent > a,
.navbar-nav li.menu-item.current-menu-parent > span.um-anchoremulator,
.navbar-nav li.menu-item.current-menu-ancestor > a,
.navbar-nav li.menu-item.current-menu-ancestor > span.um-anchoremulator,
...
@media (max-width: 767px) {
	...
	.navbar-nav .dropdown-menu,
	.navbar-toggler	{
        border-color: #' . evolve_hexDarker( $evolve_menu_back_color, 30 ) . ';
}
	...
	.navbar-nav,
	.navbar-nav .dropdown-menu {
        background: #' . evolve_hexDarker( $evolve_menu_back_color, 20 ) . ';
	}
}
';
}
...
.new-top-menu ul.nav-menu li li,
.new-top-menu ul.nav-menu li li li,
.new-top-menu ul.nav-menu li li li lis {
    border-color: #' . evolve_hexDarker( $evolve_top_menu_back_color ) . ';
}
';
}
...
if ( $evolve_pos_logo == "left" || $evolve_pos_logo == "right" || $evolve_pos_logo == "center" ) {
	$evolve_css_data .= '
.sticky-header #logo {
    float: left;
...
@media (min-width: 992px) {
    .da-slide h2 {
        font-size: ' . $evolve_options['evl_parallax_slide_title_font']['font-size'] . ';
        line-height: 1em;
    }
    #slide_holder .featured-title a {
        font-size: ' . $evolve_options['evl_carousel_slide_title_font']['font-size'] . ';
        line-height: 1em;
    }
    .da-slide p {
        font-size: ' . $evolve_options['evl_parallax_slide_subtitle_font']['font-size'] . ';
    }
    #slide_holder p {
        font-size: ' . $evolve_options['evl_carousel_slide_subtitle_font']['font-size'] . ';
    }
}
';
