...
/*!
        ...
        !*/
;g.addTest("cssanimations",v("animationName","a",true));w();m(A);delete D.addTest;delete D.addAsyncTest;for(var u=0;u<g._q.length;u++){g._q[u]()}h.Modernizr=g})(window,document);jQuery(function(a){a("#da-slider").cslider({autoplay:true,bgincrement:450,interval:evolve_js_local_vars.parallax_speed})})};