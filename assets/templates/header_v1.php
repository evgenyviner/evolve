            ...
            <div class="header">
                ...
                <div class="container container-header header_v0">	
                    <div class="row align-items-center">				
                        ...
                        <div class="col order-1 order-sm-1 order-md-3">
                        ...
                        ?>
                        <?php
                        $tagline = '<div class="col-md-auto order-2 order-md-2"><div id="tagline">' . get_bloginfo('description') . '</div></div>';
                        ...
                        if ($evolve_blog_title == "0" || !$evolve_blog_title) {
                            if (is_front_page()) :
                                ?>
                                <div class="col-md-auto order-1 order-sm-2 order-md-2"><h1 id="logo"><a href="<?php echo home_url(); ?>"><?php bloginfo('name') ?></a></h1></div>
                            <?php else : ?> 
                                <div class="col-md-auto order-1 order-sm-2 order-md-2"><div id="logo"><a href="<?php echo home_url(); ?>"><?php bloginfo('name') ?></a></div></div>
                            <?php
                            endif;
                        } else {
