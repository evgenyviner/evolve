...
if ( $evolve_pos_logo == "center" && ! empty( $evolve_header_logo ) ) {
	$evolve_css_data .= '#logo, #tagline, .header #logo-image { float: none; margin: 5px auto; } #logo, #tagline, .header-logo-container{ display:inline-block; text-align:center; width:100%} #logo, #tagline, .container .container-header { position: relative; } .title-container { text-align: center; }';
}
...
if ( $evolve_custom_background == "1" ) {
	$evolve_css_data .= '#wrapper { margin: 0 auto 30px auto; background: #f9f9f9; box-shadow: 0 0 3px rgba(0, 0, 0, .2); } #wrapper:before { -webkit-box-shadow: 0 0 9px rgba(0, 0, 0, 0.6); -moz-box-shadow: 0 0 9px rgba(0, 0, 0, 0.6); box-shadow: 0 0 9px rgba(0, 0, 0, 0.6); left: 30px; right: 30px; position: absolute; z-index: -1; height: 20px; bottom: 0px; content: ""; -webkit-border-radius: 100px / 10px; -moz-border-radius: 100px / 10px; border-radius: 100px / 10px; }@media screen and (min-width: 767px) {#wrapper {position: relative; }}';
}
...
$evolve_css_data .= '.header { padding-top: ' . $evolve_padding_top . '; padding-bottom: ' . $evolve_padding_bottom . '; } .header .container { padding-left: ' . $evolve_padding_left . '; padding-right: ' . $evolve_padding_right . '; } .navbar-nav > li, ' .
                    // TODO
                    // remove
                    'ul.nav-menu > li { padding: 0 ' . $evolve_menu_padding . 'px; }';
